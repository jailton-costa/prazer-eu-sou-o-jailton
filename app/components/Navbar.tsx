  ...
  return (
    <nav className="flex justify-center items-center bg-verde-300 backdrop-blur-md border-b-2 rounded-b-2xl border-verde-100 shadow-sm">
      <div className="container mx-auto px-3">
        <div className="flex items-center justify-between gap-10 md:gap-1 h-15 sm:text-lg md:text-xl">
          <div>
          ...
          <div className="flex justify-center items-center md:gap-3 sm:text-lg md:text-xl font-semibold text-verde-100 ">
